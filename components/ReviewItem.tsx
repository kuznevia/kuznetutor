...
import ReviewImg from 'public/assets/customer-iinteraction.jpg';
  ...
  return (
    ...
    >
      ...
      <div className="hidden  group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
        <h3 className="text-2xl text-[var(--color-secondary)] tracking-wider text-center">
          {title}
        </h3>
        ...
        <Link href={`reviews/${review.id}`}>
          <p className="text-center py-3 rounded-lg text-white bg-[var(--color-secondary)] fond-bold text-lg cursor-pointer">
            Читать полностью
          </p>
        </Link>
      </div>
